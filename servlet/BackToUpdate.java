 ...
 */
@WebServlet("/BackToUpdate")
public class BackToUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("loginName") == null || empLog.getAuthority() == 1) { // emp情報を格納したオブジェクト"loginName"を取得できなければ
			...
			request.getRequestDispatcher("/jsp/update/update_input2.jsp").forward(request, response);
		}
